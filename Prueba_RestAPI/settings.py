"""
Django settings for Prueba_RestAPI project.
...
SECRET_KEY = 'django-insecure-sla2rs&2lnl+awszye2m0u#uk&k3tzqflsodmf=kb1fq-ki8%8'
...
ROOT_URLCONF = 'Prueba_RestAPI.urls'
...
WSGI_APPLICATION = 'Prueba_RestAPI.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'bookshop_vn1i_rzcz',  # Nombre de la base de datos
        'USER': 'stiven',  # Usuario  
        'PASSWORD': 'RMCGRWsHuZw9pJEFw90Pwf88SBuizyYl',# Contraseña
        # External Database URL sin "postgresql://"
        'HOST': 'dpg-cvi8a17noe9s739rg6dg-a',
        'PORT': '5432',  # Puerto de PostgreSQL
        'OPTIONS': {
